                        ...
                        <div class="join-user-info">
                                ...
                                <ul>
                                    <li class="join-input-box">
                                       ...
                                       <h2>성별*</h2>
                                        ...
                                        <h2>생년월일*</h2>
                                        <input name="birthdayyy" id="birthdayyy" class="join-input-birthday " >
                                        <input name="birthdaymm" id="birthdaymm" class="join-input-birthday " >
                                        <input name="birthdaydd" id="birthdaydd" class="join-input-birthday " >
                                    </li>
                                    <li class="join-input-box">
                                        <h2>이메일*</h2>
                           ...
                           <div class="join-userinfo-right">
                                <ul>
                                    <li class="join-input-box">
                                        <h2>이름(영문)*</h2>
                                        <input id= "ename1" name="ename1" class="join-input-ename" placeholder="영어 닉네임">
