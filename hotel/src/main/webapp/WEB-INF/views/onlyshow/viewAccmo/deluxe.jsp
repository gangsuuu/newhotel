	...
	<div class="content">
       <div class="content_lists">
            <div class="content_inmenu">
                ...
                <ul>
                    <li id="content_list_one"><a href="http://localhost:9000/hotel/shillaStay/accommodation/standard.do" class="content_list">스탠다드</a></li>
                    <li id="content_list_one"><a href="http://localhost:9000/hotel/shillaStay/accommodation/deluxe.do" class="content_list">디럭스</a></li>
                    <li id="content_list_bundle"><a href="http://localhost:9000/hotel/shillaStay/accommodation/deluxe.do" class="content_list sub_list content_selected">디럭스</a></li>
                    <li id="content_list_bundle"><a href="http://localhost:9000/hotel/shillaStay/accommodation/deluxeOnDol.do" class="content_list sub_list">디럭스 온돌</a></li>
                    <li id="content_list_one"><a href="http://localhost:9000/hotel/shillaStay/accommodation/primierDeluxe.do" class="content_list ">프리미어 디럭스</a></li>
                    <li id="content_list_one"><a href="http://localhost:9000/hotel/shillaStay/accommodation/grand.do" class="content_list">그랜드</a></li>
                    <li id="content_list_one"><a href="http://localhost:9000/hotel/shillaStay/accommodation/allrooms.do" class="content_allrooms btn">전체 객실 보기</a></li>
                </ul>
            </div>
        </div>
