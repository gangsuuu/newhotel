       ...
       <div class="content_lists">
            <div class="content_inmenu">
                ...
                <ul>
                    ...
                    <li id="content_list_bundle"><a href="http://localhost:9000/hotel/shillaStay/accommodation/deluxe.do" class="content_list sub_list">디럭스</a></li>
                    <li id="content_list_bundle"><a href="http://localhost:9000/hotel/shillaStay/accommodation/deluxeOnDol.do" class="content_list sub_list content_selected">디럭스 온돌</a></li>
